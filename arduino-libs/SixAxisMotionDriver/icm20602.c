/*
 * icm20202.h
 * Copied from: https://github.com/mreutman/icm20602
 */
/***** Includes *****/
...
int8_t
icm20602_reset(struct icm20602_dev * dev)
{
  int8_t r = 0;
  if ((!dev->hal_wr) || (!dev->hal_rd) || (!dev->hal_sleep)) {
    return false;
...
icm20602_init(struct icm20602_dev * dev)
{
  ...
  // Doco says startup time to register read-write is 2 ms
  // Anecdotal evidence says 4 ms leads to errors
  dev->hal_sleep(10);
